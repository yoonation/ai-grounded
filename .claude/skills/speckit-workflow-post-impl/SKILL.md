...
description: "Dispatch downstream verifiers at the post-implementation checkpoint (C3): code/security review + closure-auditor"
argument-hint: "Optional: feature directory path (defaults to active feature)"
compatibility: "Requires spec-kit project structure with .specify/ directory, an approved feature-concerns.yaml, tooling/dispatch, and the C3 sub-agents"
metadata:
  author: "ai-grounded-framework"
  source: "workflow:commands/speckit.workflow.post-impl.md"
user-invocable: true
