<!--
  Source: github.com/github/spec-kit/templates/commands/plan.md @ v0.8.11
  License: MIT (upstream)
  Modifications: framework additions for the governance workflow:
  rename-integrity verification after bulk identifier changes and
  the data-model normalization gate.
